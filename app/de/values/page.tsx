              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    style={{ background: "radial-gradient(circle at 20% 0%, rgba(37,99,235,0.16), transparent 60%)" }}
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          >
            ...
            <blockquote className="text-2xl sm:text-3xl font-medium text-white leading-relaxed mb-8 drop-shadow-sm">
              Digitale Bildung zu transformieren und die Zukunft des lebenslangen Lernens zu gestalten schafft Chancengerechtigkeit.
            </blockquote>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Den digitalen Wandel voranzutreiben, digitale Kompetenzen in allen Bereichen der Gesellschaft zu verankern und eine inklusive, zukunftsorientierte digitale Welt mitzugestalten, ist unsere Mission.
            </p>
          </motion.div>
            ...
            {beliefs.map((belief, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 pointer-events-none"
                    style={{ background: "radial-gradient(circle at 50% 0%, rgba(37,99,235,0.18), transparent 70%)" }}
                  ...
                  <div className="relative bg-white rounded-3xl border border-gray-100 shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col w-full h-[420px]">
                    <div className="relative w-full h-[220px] shrink-0">
                      <Image src={belief.image} alt={belief.title} fill className="object-cover" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 20vw" />
                    ...
                    <div className="p-5 flex flex-col justify-start text-left flex-1 min-h-[200px] min-w-0">
                      <div className="flex items-start gap-3 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-[#0066FF] text-base font-bold mb-1 relative z-10">{belief.title}</h3>
