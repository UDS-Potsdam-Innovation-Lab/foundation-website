...
const PURPOSES = [
  {
    ...
    description:
      "Förderung und Finanzierung der German University of Digital Science sowie deren strategischen Initiativen und Partnerschaften",
  ...
  },
  {
    ...
    description:
      "Bereitstellung leicht zugänglicher und hochwertiger digitaler Bildung über die Online-Lernplattform der German UDS",
    image: "/support-german-uds.jpg",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 z-10">
          ...
          >
            ...
            <p className="text-base sm:text-xl text-gray-600">
              ...
              <br />
              Unterstützen Sie die German UDS Foundation mit Ihrer Spende
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Erfahren Sie, wie Ihre Unterstützung die German UDS stärkt und die digitale Bildung
              voranbringt
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-2 text-lg text-gray-600">
              Fördern Sie die Stiftung und helfen Sie, die digitale Bildung zu transformieren
            </p>
          </motion.div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1 max-w-xl">
                      Die German UDS Foundation ist berechtigt, Bescheinigungen gemäß §50 Abs.1 EStDV
                      auszustellen.
                    </p>
                  </div>
                </div>
