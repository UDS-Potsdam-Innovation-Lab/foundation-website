...
export default function Page() {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      desc: 'Unterstützen Sie uns, erhalten Sie Stipendien und fördern Sie Projekte.',
      href: '/de/funding',
      accent: 'blue',
      large: false,
    },
    {
      ...
      desc: 'Werden Sie Teil der Mission.',
    ...
    {
      icon: Globe2,
      title: 'German UDS Ökosystem',
      desc: 'Verstehen Sie das erweiterte German UDS Ökosystem.',
      href: '/de/ecosystem',
      accent: 'blue',
      large: false,
    },
