    ...
    <main className="pt-24 bg-gradient-to-b from-[#dbeafe] via-[#a3c9f1] to-[#5a8ac3] scroll-smooth">
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-[#000080]">Kontakt</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-stretch">
            ...
            >
              <div className="bg-[#dbeafe] rounded-br-2xl border border-gray-300 hover:shadow-2xl hover:ring-2 hover:ring-orange-500 p-6 sm:p-8 text-[#0a0f4a]">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-[#f7931e]">Adresse</h2>
              ...
              <div className="bg-[#dbeafe] rounded-br-2xl border border-gray-300 hover:shadow-2xl hover:ring-2 hover:ring-orange-500 p-6 sm:p-8 text-[#0a0f4a]">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-[#f7931e]">Kontaktdaten</h2>
              ...
              <div className="bg-[#dbeafe] rounded-br-2xl border border-gray-300 hover:shadow-2xl hover:ring-2 hover:ring-orange-500 p-6 sm:p-8 text-[#0a0f4a]">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-[#f7931e]">Spendeninformationen</h2>
