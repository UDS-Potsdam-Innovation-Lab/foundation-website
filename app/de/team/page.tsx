...
export default function Team() {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: 'Wulf Wersig war bis 2016 Schulleiter und Geschäftsführer des Regionalen Berufsbildungszentrums Wirtschaft in der Landeshauptstadt Kiel – eine Einrichtung, die 2014 mit dem Deutschen Schulpreis ausgezeichnet wurde. Nach seinem Studium der Volkswirtschaftslehre und Wirtschaftspädagogik in Kiel und Berlin erlebte er die digitale Transformation von Beginn an und setzte sie aktiv in seinem beruflichen Umfeld um. Von 2017 bis 2023 war er Geschäftsführer der Trägergesellschaft German UDS gGmbH.',
    },
    {
