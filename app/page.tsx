...
export default function Page() {
  ...
  const quickLinks = [
    ...
    {
      icon: Target,
      title: 'Guiding Principles & Mission',
      desc: 'Our values that guide decisions and impact.',
      href: '/values',
      accent: 'blue',
      large: false,
    },
    {
      icon: Lightbulb,
      title: 'Funding',
      desc: 'Support us, access scholarships, and fund projects.',
      href: '/funding',
      accent: 'blue',
      large: false,
    },
    ...
    },
    {
      ...
      desc: 'Understand the broader German UDS ecosystem.',
      href: '/ecosystem',
      accent: 'blue',
      large: false,
    },
